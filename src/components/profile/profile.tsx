...
export function Profile({ name }: ProfileProps) {
    ...
    const {
        ...
        isLoading: minecraftIsLoading,
    } = useSWR<PlayerMinecraftStats>(`/api/profile/${name}`, fetcher);
    const {
        data: serverData,
        error: serverError,
                    ...
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded-lg shadow-md">
                            ...
                            <ul className="text-white list-disc list-inside">
                                {Object.entries(minecraftData.stats['minecraft:custom']).map(([stat, value]) => (
                                    <li key={stat} className="text-white">
                                        {convertName(stat)}: {value}
                                    </li>
                                ))}
                            </ul>
                        </div>
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded-lg shadow-md">
                            ...
                            <ul className="text-white list-disc list-inside">
                                <h3 className="text-white font-semibold">
                                    Total :{' '}
                                    {Object.values(minecraftData.stats['minecraft:used']).reduce(
                                        (acc, val) => acc + val,
                                        0
                                    )}
                                </h3>
                        ...
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded-lg shadow-md">
                            ...
                            <ul className="text-white list-disc list-inside">
                                <h3 className="text-white font-semibold">
                                    Total :{' '}
                                    {Object.values(minecraftData.stats['minecraft:mined']).reduce(
                                        (acc, val) => acc + val,
                                        0
                                    )}
                                </h3>
                                {Object.entries(minecraftData.stats['minecraft:mined']).map(([block, count]) => (
                                    <li key={block} className="text-white">
                                        {convertName(block)}: {count}
                                    </li>
                                ))}
                            </ul>
                        </div>
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded-lg shadow-md">
                            ...
                            <ul className="text-white list-disc list-inside">
                                <h3 className="text-white font-semibold">
                                    Total :{' '}
                                    {Object.values(minecraftData.stats['minecraft:crafted']).reduce(
                                        (acc, val) => acc + val,
                                        0
                                    )}
                                </h3>
                        ...
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded-lg shadow-md">
                            ...
                            <ul className="text-white list-disc list-inside">
                                <h3 className="text-white font-semibold">
                                    Total :{' '}
                                    {Object.values(minecraftData.stats['minecraft:picked_up']).reduce(
                                        (acc, val) => acc + val,
                                        0
                                    )}
                                </h3>
                        ...
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded-lg shadow-md">
                            ...
                            <ul className="text-white list-disc list-inside">
                                <h3 className="text-white font-semibold">
                                    Total :{' '}
                                    {Object.values(minecraftData.stats['minecraft:dropped']).reduce(
                                        (acc, val) => acc + val,
                                        0
                                    )}
                                </h3>
                        ...
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded-lg shadow-md">
                            ...
                            <ul className="text-white list-disc list-inside">
                                <h3 className="text-white font-semibold">
                                    Total :{' '}
                                    {Object.values(minecraftData.stats['minecraft:killed']).reduce(
                                        (acc, val) => acc + val,
                                        0
                                    )}
                                </h3>
                                {Object.entries(minecraftData.stats['minecraft:killed']).map(([entity, count]) => (
                                    <li key={entity} className="text-white">
                                        {convertName(entity)}: {count}
                                    </li>
                                ))}
                            </ul>
                        </div>
